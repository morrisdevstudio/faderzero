...
function SongPlayButton({
  ...
  return (
    <button
      ...
      className={[
        'flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl transition-all duration-150 disabled:cursor-not-allowed disabled:opacity-35',
        isPlaying ? 'bg-[var(--fz-accent)] text-white shadow-md' : 'bg-white/10 text-white hover:bg-white/15 active:scale-95',
      ].join(' ')}
    >
                ...
                <>
                  ...
                  <span className="mt-1 flex items-center gap-2 overflow-hidden text-[0.84rem] font-medium text-white/65">
                    ...
                    <span className="truncate">
                      ...
                      {' · '}
                      {summary.setlistCount || 0} setlist{(summary.setlistCount || 0) > 1 ? 's' : ''}
                    </span>
                  </span>
                </>
              }
                ...
                return (
                  ...
                  >
                    <span className={[
                      ...
                      isPlaying ? 'bg-[var(--fz-accent)] text-white' : 'bg-white/10 text-white',
                    ].join(' ')}>
