  ...
  return (
    <div className="space-y-4">
      ...
      <section className="rounded-[1.6rem] border border-white/10 bg-white/[0.045] p-5">
        ...
        <h2 className="mt-2 text-lg font-black uppercase tracking-[0.16em] text-white">D�connexion</h2>
        <p className="mt-2 text-sm leading-relaxed text-[var(--fz-text-muted)]">
          Ferme ta session sur cet appareil. Tes donn�es locales et morceaux en cache restent conserv�s.
        </p>
        <button
          type="button"
