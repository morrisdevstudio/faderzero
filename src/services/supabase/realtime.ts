...
const REALTIME_TABLES = ['songs', 'setlists', 'setlist_songs', 'song_assets', 'song_timelines', 'timeline_sections', 'events', 'event_contacts', 'workspace_contacts', 'booking_leads', 'booking_notes', 'booking_lead_contacts'] as const;
