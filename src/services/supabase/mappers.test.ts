    ...
    it('converts DbSong to SongRecord and vice versa', () => {
      const dbSong: DbSong = {
        ...
        lyrics_document: {
          ...
          content: [{
            type: 'songSection',
            attrs: { id: 'section-1', sectionType: 'verse', label: 'Couplet' },
            content: [{
              type: 'paragraph',
              attrs: { id: 'paragraph-1' },
              content: [{ type: 'text', text: 'Is this real life?' }],
            }],
          }],
        },
      ...
      expect(localSong).toEqual({
        ...
        artist: 'Queen',
        lyrics: 'Is this real life?',
        lyricsDocument: dbSong.lyrics_document,
      ...
      expect(convertedBack).toEqual({
        ...
        artist: 'Queen',
        lyrics: 'Is this real life?',
        lyrics_document: dbSong.lyrics_document,
        lyrics_document_version: 1,
        key: 'Bb',
        bpm: 72,
        status: 'Pret',
