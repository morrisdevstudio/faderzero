/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/audio-worker/wrangler.jsonc cloudflare/audio-worker/worker-configuration.d.ts` (hash: ea73dc3374bd9c11faa492d4c697d907)
// Runtime types generated with workerd@1.20260730.1 2026-07-17 nodejs_compat
interface __BaseEnv_Env {
	AUDIO_BUCKET: R2Bucket;
	AUDIO_BACKUP_BUCKET: R2Bucket;
	EPK_PUBLIC_BUCKET: R2Bucket;
	...
	APP_URL: "https://app.faderzero.com";
	ALLOWED_ORIGINS: "http://localhost:5173,https://localhost:5173,http://192.168.1.23:5173,https://app.faderzero.com,https://faderzero.pages.dev,https://faderzero-server.tailfba668.ts.net:8443";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "EPK_PUBLIC_MEDIA_ORIGIN" | "GOOGLE_OAUTH_REDIRECT_URI" | "APP_URL" | "ALLOWED_ORIGINS" | "GOOGLE_OAUTH_CLIENT_ID" | "GOOGLE_OAUTH_CLIENT_SECRET" | "GOOGLE_TOKEN_ENCRYPTION_KEY" | "SUPABASE_SECRET_KEY" | "URL_SIGNING_SECRET">> {}
}
