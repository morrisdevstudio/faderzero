/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/audio-worker/wrangler.jsonc cloudflare/audio-worker/worker-configuration.d.ts` (hash: 6cdd31252463fb05ca2c4b9c6a8c5e93)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "EPK_PUBLIC_MEDIA_ORIGIN" | "ALLOWED_ORIGINS">> {}
}
