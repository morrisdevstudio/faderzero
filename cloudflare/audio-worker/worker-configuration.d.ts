/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/audio-worker/wrangler.jsonc cloudflare/audio-worker/worker-configuration.d.ts` (hash: d4050c516c712fe845d3fe99d79337e6)
