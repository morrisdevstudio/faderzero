/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/audio-worker/wrangler.jsonc cloudflare/audio-worker/worker-configuration.d.ts` (hash: c064084b3682464f92872e712a2ee4c3)
