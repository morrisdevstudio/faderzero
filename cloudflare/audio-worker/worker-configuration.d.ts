/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/audio-worker/wrangler.jsonc cloudflare/audio-worker/worker-configuration.d.ts` (hash: d9baa496cf99ee3f332fe7cc74972bd6)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "http://localhost:5173,https://localhost:5173,https://faderzero.pages.dev,https://*.faderzero.pages.dev,https://faderzero-server.tailfba668.ts.net:8443";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "ALLOWED_ORIGINS">> {}
}
