/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=.\cloudflare\audio-worker\wrangler.jsonc .\cloudflare\audio-worker\worker-configuration.d.ts` (hash: b343ec2a8d049207cd0921b44b09cb31)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "http://localhost:5173,https://localhost:5173,https://faderzero.pages.dev,https://*.faderzero.pages.dev";
}
