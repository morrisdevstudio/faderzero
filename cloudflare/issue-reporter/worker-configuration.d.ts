/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/issue-reporter/wrangler.jsonc cloudflare/issue-reporter/worker-configuration.d.ts` (hash: 10e737b654dec5939f0d7345c5f844d3)
...
interface __BaseEnv_Env {
	...
	ALLOWED_ORIGINS: "http://localhost:5173,https://localhost:5173,https://app.faderzero.com,https://faderzero.pages.dev";
	GITHUB_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "AUTHORIZED_REPORTER_EMAIL" | "GITHUB_REPOSITORY" | "PUBLIC_ASSET_ORIGIN" | "ALLOWED_ORIGINS" | "GITHUB_TOKEN">> {}
}
