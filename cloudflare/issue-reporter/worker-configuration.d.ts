/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/issue-reporter/wrangler.jsonc cloudflare/issue-reporter/worker-configuration.d.ts` (hash: 806fb3b2d8115eae81754cfad325cda0)
// Runtime types generated with workerd@1.20260730.1 2026-09-12 nodejs_compat
interface __BaseEnv_Env {
	ISSUE_REPORTS_BUCKET: R2Bucket;
	...
	PUBLIC_ASSET_ORIGIN: "https://faderzero-issue-reporter.admin-morris-studio.workers.dev";
	ALLOWED_ORIGINS: "http://localhost:5173,https://localhost:5173,https://app.faderzero.com,https://faderzero.pages.dev,https://*.faderzero.pages.dev";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "AUTHORIZED_REPORTER_EMAIL" | "GITHUB_REPOSITORY" | "PUBLIC_ASSET_ORIGIN" | "ALLOWED_ORIGINS">> {}
}
