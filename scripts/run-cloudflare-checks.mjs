...
const checks = [
  ...
  ['Issue Reporter TypeScript', 'npm', ['run', 'typecheck:issue-reporter']],
  ['Lint', 'npm', ['run', 'lint']],
  ['Tests', 'npm', ['test']],
  ['Audio Worker tests', 'npm', ['run', 'test:worker']],
  ['EPK Worker tests', 'npm', ['run', 'test:epk']],
  ['Issue Reporter tests', 'npm', ['run', 'test:issue-reporter']],
  ...
  ['Issue Reporter types', 'npx', [...wrangler, 'types', '--check', '--config', 'cloudflare/issue-reporter/wrangler.jsonc', 'cloudflare/issue-reporter/worker-configuration.d.ts']],
  ['Issue Reporter dry-run', 'npx', [...wrangler, 'deploy', '--dry-run', '--config', 'cloudflare/issue-reporter/wrangler.jsonc']],
